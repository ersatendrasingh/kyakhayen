      ...
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-y-2">
            <h1 className="text-2xl font-medium">Edit article Category</h1>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          <div>
            ...
            <CategoryNameForm initialData={category} categoryId={category.id} />
          </div>
          <div className="space-y-6">
            <div>
              ...
              <ImageForm initialData={category} categoryId={category.id} />
            </div>
          </div>
        </div>
      </div>
