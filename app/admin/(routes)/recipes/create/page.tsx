...
const RecipeCreatePage = () => {
  ...
  return (
    <div className="flex max-w-5xl mx-auto md;items-center md:justify-center h-full p-6">
      <div>
        <h1 className="text-2xl">Name your recipe</h1>
        <p className="text-sm text-slate-600">
          What would you like to name your recipe? Don&apos;t worry it can be
          changed later
        </p>
        <Form {...form}>
          <form
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      placeholder="e.g. 'Chocolate-Berry Protein Smoothie'"
                      {...field}
                    />
                  </FormControl>
