      ...
      <div className="bg-white max-w-5xl mx-auto p-6 rounded-lg shadow-md flex flex-col lg:flex-row items-center text-center lg:text-left border border-gray-200">
        <div className="lg:w-1/2 lg:pr-8">
          ...
          <p className="text-md mb-6">
            Personalization helps us create a meal plan tailored to your unique
            dietary preferences and nutritional needs. By completing your
            personalization, you will get:
          </p>
